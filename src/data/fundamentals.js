	...
	areas: [
		{
			...
			skills: [
				...
				},
				{
					name: "Svg",
					description: {
						text: "Learn how to work with SVG files to make graphics look for diffrent screen resolutions.",
						links: [
							...
							["SVG Selfhtml", "https://wiki.selfhtml.org/wiki/SVG/Tutorials/Einstieg"]
